...
##########AAAAAAAAAA
    if ($array[1] =~ m/^A/ && $array[72] > $pa && $array[73] > $pa && $array[74] > $pa && $array[75] > $pa && $array[80] > $pa && $array[81] > $pa && $array[82] > $pa && $array[83] > $pa && $array[84] > $pa && $array[85] > $pa ) {
        print "$array[0]\tA\t@array[4..6]\tcsaA,$array[72]\tcsaB,$array[73]\tcsaC,$array[74]\tcsaD,$array[75]\t_\t_\t_\tComplete_capsule\n";
    }
    elsif ($array[1] =~ m/^A/ ) {
        print "$array[0]\tNG\t@array[4..6]\tcsaA,$array[72]\tcsaB,$array[73]\tcsaC,$array[74]\tcsaD,$array[75]\t_\t_\t_\tPartial_or_Missing_essential_gene\n";
    }
##########BBBBBBBBBB    
        ...
        print "$array[0]\tB\t@array[4..6]\tcssA,$array[72]\tcssB,$array[73]\tcssC,$array[74]\tcsb,$array[75]\tctrG,$array[76]\t_\t_\tComplete_capsule\n";
    }
    elsif ($array[1] =~ m/^B/ ) {
        print "$array[0]\tNG\t@array[4..6]\tcssA,$array[72]\tcssB,$array[73]\tcssC,$array[74]\tcsb,$array[75]\tctrG,$array[76]\t_\t_\tPartial_or_Missing_essential_gene\n";
    }
##########CCCCCCCCCC    
        ...
        print "$array[0]\tC\t@array[4..6]\tcssA,$array[72]\tcssB,$array[73]\tcssC,$array[74]\tcsc,$array[75]\tcssE,$array[76]\tctrG,$array[77]\t_\tComplete_capsule\n";
    }
    elsif ($array[1] =~ m/^C/ ) {
        print "$array[0]\tNG\t@array[4..6]\tcssA,$array[72]\tcssB,$array[73]\tcssC,$array[74]\tcsc,$array[75]\tcssE,$array[76]\tctrG,$array[77]\t_\tPartial_or_Missing_essential_gene\n";
    }
##########EEEEEEEEEE    
...
##########WWWWWWWWWW    
        ...
        print "$array[0]\tW\t@array[4..6]\tcssA,$array[72]\tcssB,$array[73]\tcssC,$array[74]\tcsw,$array[75]\tcssF,$array[76]\tctrG,$array[77]\t_\tComplete_capsule\n";
    }
    elsif ($array[1] =~ m/^W/ ) {
        print "$array[0]\tNG\t@array[4..6]\tcssA,$array[72]\tcssB,$array[73]\tcssC,$array[74]\tcsw,$array[75]\tcssF,$array[76]\tctrG,$array[77]\t_\tPartial_or_Missing_essential_gene\n";
    }
##########YYYYYYYYYY    
        ...
        print "$array[0]\tY\t@array[4..6]\tcssA,$array[72]\tcssB,$array[73]\tcssC,$array[74]\tcsy,$array[75]\tcssF,$array[76]\tctrG,$array[77]\t_\tComplete_capsule\n";
    }
    elsif ($array[1] =~ m/^Y/ ) {
        print "$array[0]\tNG\t@array[4..6]\tcssA,$array[72]\tcssB,$array[73]\tcssC,$array[74]\tcsy,$array[75]\tcssF,$array[76]\tctrG,$array[77]\t_\tPartial_or_Missing_essential_gene\n";
    }
##########XXXXXXXXXX
    if ($array[1] =~ m/^X/ && $array[72] > $pa && $array[73] > $pa && $array[74] > $pa && $array[80] > $pa && $array[81] > $pa && $array[82] > $pa && $array[83] > $pa && $array[84] > $pa && $array[85] > $pa ) {
        print "$array[0]\tX\t@array[4..6]\tcsxA,$array[72]\tcsxB,$array[73]\tcsxC,$array[74]\t_\t_\t_\t_\tComplete_capsule\n";
    }
    elsif ($array[1] =~ m/^X/ ) {
        print "$array[0]\tNG\t@array[4..6]\tcsxA,$array[72]\tcsxB,$array[73]\tcsxC,$array[74]\t_\t_\t_\t_\tPartial_or_Missing_essential_gene\n";
    }
##########ZZZZZZZZZZ
    if ($array[1] =~ m/^Z/ && $array[72] > $pa && $array[73] > $pa && $array[74] > $pa && $array[75] > $pa && $array[80] > $pa && $array[81] > $pa && $array[82] > $pa && $array[83] > $pa && $array[84] > $pa && $array[85] > $pa ) {
        print "$array[0]\tZ\t@array[4..6]\tcszA,$array[72]\tcszB,$array[73]\tcszC,$array[74]\tcszD,$array[75]\t_\t_\t_\tComplete_capsule\n";
    }
    elsif ($array[1] =~ m/^Z/ ) {
        print "$array[0]\tNG\t@array[4..6]\tcszA,$array[72]\tcszB,$array[73]\tcszC,$array[74]\tcszD,$array[75]\t_\t_\t_\tPartial_or_Missing_essential_gene\n";
    }
##########NANANANANA
